...
int main(int argc, char const *argv[])
{
    if(argc == 1)
    {
        ...
        // Listening and accepting new connections will be done in Exec'd child
        /*
        ...
        */
        ...
        else if(pid == 0)
        {
            ...
            printf("Exec'ing the child (This will listen and accept new connections)\n" );
            execv("./server",args);
            return 0;
        }
        else{
